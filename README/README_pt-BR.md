...
- Diálogo de **editor EXIF** — descrição, artista, copyright, câmera e comentário (Unicode incluído) gravados em um JPEG sem pacote extra, sem alterar pixels nem as outras tags (WebP precisa de `piexif`)
