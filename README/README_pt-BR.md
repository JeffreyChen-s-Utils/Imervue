...
- **Mais formatos** — ICO, TGA, DDS, QOI, JPEG 2000 (.jp2 / .j2k / .jpf / .jpx), Netpbm (PPM / PGM / PBM / PNM), PCX abrem para visualização, lidos pelo próprio Pillow; girar um no lugar e outras regravações são recusados, então uma edição sai por Salvar como / Exportar
