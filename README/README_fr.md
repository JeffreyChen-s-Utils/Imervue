...
- **Liste (détail)** — bascule avec `Ctrl+L` ; colonnes : Aperçu · Étiquette · Nom · Résolution · Taille · Type · Modifié; `Delete` retire les lignes sélectionnées et `Ctrl+Z` les rétablit, comme dans la grille
