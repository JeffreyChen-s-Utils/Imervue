...
- **Liste (Detail)** — Umschalten mit `Ctrl+L`; Spalten: Preview · Label · Name · Auflösung · Größe · Typ · Geändert; `Delete` entfernt die markierten Zeilen und `Ctrl+Z` holt sie zurück, wie im Grid
