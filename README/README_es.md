...
- **Lista (detalle)** — se alterna con `Ctrl+L`; columnas: Vista previa · Etiqueta · Nombre · Resolución · Tamaño · Tipo · Modificado; `Delete` quita las filas seleccionadas y `Ctrl+Z` las recupera, y las teclas de valoración (`0`–`5`), selección (`P` / `Shift+X` / `U`) y color (`F1`–`F5`) las marcan, como en la cuadrícula
