...
- **#23** One module is within 50 lines of the 1,000-line limit: `gui/annotation_dialog.py` (956). Next step: move one cohesive group of methods out of each into its own module (characterisation tests first), largest first.
