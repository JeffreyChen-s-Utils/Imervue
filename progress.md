...
- **#4** 6 files are over the 1000-line limit (`architecture_explore.md` §12); the largest are `Imervue/Imervue_main_window.py` (2268) and `Imervue/paint/canvas.py` (1852).
