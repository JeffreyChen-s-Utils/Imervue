...
- **#23** Two modules are within 50 lines of the 1,000-line limit: `gpu_image_view/overlay_painter.py` (963), `gui/annotation_dialog.py` (956). Next step: move one cohesive group of methods out of each into its own module (characterisation tests first), largest first.
