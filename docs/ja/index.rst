...
.. list-table::
   ...
   * - **Modify**
     - 非破壊現像パイプライン — スライダー、カーブ、LUT、マスク、レタッチ、多画像合成。
       「Modify タブ — 非破壊現像」を参照。
   * - **Paint**
     - MediBang スタイルのラスター描画スタジオ。ブラシ、レイヤー、アニメ、漫画ツール、PSD I/O 搭載。
       「Paint タブ — MediBang スタイル描画」を参照。
   * - **Puppet**
...
3 つ目のトップレベルタブ — **ペイント** — は MediBang スタイルのペイント
...
``Extra Tools`` > ``Workflow`` > ``Dual-Pane File Manager`` は Total Commander 風の 2 ペイ
