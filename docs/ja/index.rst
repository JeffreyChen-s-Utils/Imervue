...
の配置、スプリッターのサイズ、アクティブなルートフォルダを名前付きで保存し、other XMP-aware photo managers が
*Library* / *Develop* / *Export* を切り替えるように、あるいは Adobe Bridge が
*Metadata* / *Filmstrip* を切り替えるように、保存済みレイアウトをワンクリックで切り替えられます。
