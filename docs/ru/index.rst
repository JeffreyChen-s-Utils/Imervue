...
Многостраничный TIFF — отсканированный документ — не проигрывается: он показывается по одной странице, листается клавишами ``,`` и ``.``, а индикатор показывает номер страницы. Кадры, которые не являются анимацией, тоже не проигрываются: превью, которое камера встраивает в JPEG (MPF), и слои PSD.
