...
.. list-table::
   ...
   * - **Paint**
     - MediBang 스타일 래스터 페인팅 스튜디오. 브러시, 레이어, 애니메이션, 만화 도구, PSD I/O.
       「Paint 탭 — MediBang 스타일 페인팅」을 참조하세요.
   * - **Puppet**
...
세 번째 최상위 탭인 **페인트** 는 MediBang 스타일의 페인팅 워크스페이스로,
...
``Extra Tools`` > ``Workflow`` > ``Dual-Pane File Manager``는 Total Commander 스타일의 두
