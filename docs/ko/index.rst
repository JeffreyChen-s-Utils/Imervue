...
스플리터 크기, 활성 루트 폴더를 이름으로 저장합니다 — 그런 다음 other
XMP-aware photo managers 가 *Library* / *Develop* / *Export* 를, Adobe
Bridge 가 *Metadata* / *Filmstrip* 를 전환하듯 저장된 레이아웃 사이를
전환할 수 있습니다. 대화상자는 현재 저장, 불러오기, 이름 변경, 삭제를
