...
DEFAULT_SHORTCUTS: dict[str, tuple[int, int]] = {
    ...
    "fit_window":       (_k(Qt.Key.Key_F), _SHIFT),
    "zoom_in":          (_k(Qt.Key.Key_Equal), _NONE),
    "zoom_out":         (_k(Qt.Key.Key_Minus), _NONE),
    ...
    "dual_page_rtl":    (_k(Qt.Key.Key_D), _CTRL_SHIFT),
...
ACTION_DISPLAY_KEYS: dict[str, str] = {
    ...
    "fit_window":       "shortcut_action_fit_window",
    "zoom_in":          "shortcut_action_zoom_in",
    "zoom_out":         "shortcut_action_zoom_out",
    ...
    "dual_page_rtl":    "shortcut_action_dual_page_rtl",
...
ACTION_FALLBACKS: dict[str, str] = {
    ...
    "fit_height": "Fit to Height", "fit_window": "Fit to Window",
    ...
    "dual_page": "Dual Page",
    "dual_page_rtl": "Dual Page (Right to Left)",
