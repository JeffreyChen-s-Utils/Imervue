...
class PaintOptionsBar(QToolBar):
    ...
    def __init__(self, state: ToolState, parent=None):
        ...
        for tool in ("eyedropper", "move", "hand", "zoom", "blur", "smudge"):
    ...
    def _build_fill_strip(lang: dict) -> QWidget:
        ...
        row.addWidget(tol)
        row.addWidget(QCheckBox(lang.get("paint_fill_contiguous", "Contiguous")))
        row.addWidget(QCheckBox(lang.get("paint_fill_all_layers", "Sample all layers")))
        row.addStretch(1)
        return widget
    ...
    def _build_text_strip(lang: dict) -> QWidget:
        ...
        size.setValue(36)
        row.addWidget(size)
        row.addWidget(QCheckBox(lang.get("paint_text_bold", "Bold")))
        row.addWidget(QCheckBox(lang.get("paint_text_italic", "Italic")))
        row.addStretch(1)
        return widget
    ...
    def _build_gradient_strip(lang: dict) -> QWidget:
        ...
        row.addWidget(kind)
        row.addWidget(QCheckBox(lang.get("paint_gradient_reverse", "Reverse")))
        row.addStretch(1)
        return widget
