...
DEFAULT_SHORTCUTS: tuple[ShortcutEntry, ...] = (
    ...
    ShortcutEntry("paint.tool.smudge", "paint_shortcut_tool_smudge", "R"),
    ShortcutEntry("paint.tool.blur", "paint_shortcut_tool_blur", "Shift+R"),
    ShortcutEntry("paint.tool.line", "paint_shortcut_tool_line", "L"),
    ShortcutEntry("paint.tool.rect", "paint_shortcut_tool_rect", "O"),
    ShortcutEntry("paint.tool.select_rect", "paint_shortcut_tool_select_rect", "M"),
    ShortcutEntry("paint.tool.lasso", "paint_shortcut_tool_lasso", "Shift+L"),
    ShortcutEntry("paint.tool.wand", "paint_shortcut_tool_wand", "W"),
