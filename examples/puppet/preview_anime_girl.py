...
from Imervue.puppet.document_io import load_puppet    # noqa: E402
from Imervue.puppet.motion_sampler import sample_motion    # noqa: E402
from Imervue.puppet.runtime import compose_all_drawables    # noqa: E402
...
def render_frame(doc, parameter_values: dict[str, float]) -> Image.Image:
    ...
    for drawable in sorted_drawables:
        ...
        _rasterise(canvas, verts, drawable, tex)
    return canvas


def _rasterise(canvas: Image.Image, verts: np.ndarray, drawable, tex: np.ndarray) -> None:
