...
> 產出日期：2026-08-03（全樹掃描）· 最後同步：2026-09-24 · 對應 commit `46ff29c` · 分支 `dev` · 版本 `1.0.90`
>
...
其中 `Imervue/` 套件本身 761 檔 / 164,102 行。
...
163 個檔、32,880 行 —— 全部是 Qt 前端。多數對話框只是外殼，數學在 `image/`。
...
843 個檔、137,500 行。`pyproject.toml` 定義三個互斥層級 marker：
