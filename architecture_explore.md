...
> 產出日期：2026-08-03（全樹掃描）· 最後同步：2026-09-22 · 對應 commit `2979a95` · 分支 `dev` · 版本 `1.0.90`
>
...
其中 `Imervue/` 套件本身 739 檔 / 159,946 行。
...
`duplicate_detection_dialog.py`(563) 檔案雜湊 + pHash · `image_sanitize_dialog.py`(777) 淨化重繪（剝除所有隱藏資料）·
