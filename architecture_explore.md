...
> 產出日期：2026-08-03（全樹掃描）· 最後同步：2026-09-22 · 對應 commit `fbb7900` · 分支 `dev` · 版本 `1.0.90`
>
...
其中 `Imervue/` 套件本身 739 檔 / 159,827 行。
...
159 個檔、32,447 行 —— 全部是 Qt 前端。多數對話框只是外殼，數學在 `image/`。
...
769 個檔、126,725 行。`pyproject.toml` 定義三個互斥層級 marker：
